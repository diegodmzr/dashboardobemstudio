    ...
    return `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333; background-color: #f9f9f9;">
            <div style="text-align: center; margin-bottom: 30px; padding-top: 20px;">
                <img src="https://dashboard.obemstudio.com/iconlogo.png" alt="Obem Studio" style="width: 64px; height: 64px; margin-bottom: 12px;">
                <h1 style="color: #000; margin: 0; font-size: 22px; font-weight: 800; text-transform: uppercase; letter-spacing: 2px;">Obem Studio</h1>
            </div>
